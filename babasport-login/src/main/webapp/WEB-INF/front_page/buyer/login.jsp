        ...
        <form id="jvForm" action="/shopping/login.aspx" method="post">
            ...
            <ul class="uls form">
				...
				<span class="bg_text small">
                    ...
                    <img src="/shopping/getCodeImage.aspx"
                         onclick="this.src='/shopping/getCodeImage.aspx?d='+new Date()" class="code" alt="换一张"/><a
                            href="javascript:void(0);"
                            onclick="$('.code').attr('src','/shopping/getCodeImage.aspx?d='+new Date())" title="换一张">换一张</a>
                </li>
