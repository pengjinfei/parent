...
<head>
    ...
    <script type="text/javascript">
        ...
        function filterBrand(id) {
            brandId = id;
            var head = "/product/display/list.shtml?keyword=" + keyword + "&brandId=" + brandId;
            if (price) {
                head += "&price=" + price;
            }
        ...
        function filterPrice(target) {
            price = $(target).attr("title");
            var head = "/product/display/list.shtml?keyword=" + keyword + "&price=" + price;
            if (brandId) {
                head += "&brandId=" + brandId;
            }
            window.location.href = head;
        }

        function cleanFilter(key) {
            var head = "/product/display/list.shtml?keyword=" + keyword;
            if (key == "品牌") {
                if (price) {
                    head += "&price=" + price;
                }
...
<div class="w loc">
    <div class="h-title">
        ...
        <div class="h-search">
            ...
            <div class="h-se-btn"><a href="#" onclick="searchKeyword()">搜索</a></div>
        </div>
    </div>
...
<div class="w ofc">
    <div class="l wl">
        ...
        <div class="box bg_white">
            <ul class="uls x_50x50">
                ...
                <li>
                    ...
                    <a href="#" title="富一代" target="_blank" class="pic"><img src="/res/img/pic/ppp1.jpg"
                                                                             alt="依琦莲2014瑜伽服套装新"/></a>
                    <dl>
                        <!-- dt 8个文字+... -->
                        <dt><a href="#" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a></dt>
                ...
                <li>
                    ...
                    <a href="#" title="富一代" target="_blank" class="pic"><img src="/res/img/pic/ppp2.jpg"
                                                                             alt="依琦莲2014瑜伽服套装新"/></a>
                    <dl>
                        <!-- dt 8个文字+... -->
                        <dt><a href="#" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a></dt>
                ...
                <li>
                    <a href="#" title="富一代" target="_blank" class="pic"><img src="/res/img/pic/ppp3.jpg"
                                                                             alt="依琦莲2014瑜伽服套装新"/></a>
                    <dl>
                        <!-- dt 8个文字+... -->
                        <dt><a href="#" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a></dt>
                ...
                <li>
                    <a href="#" title="富一代" target="_blank" class="pic"><img src="/res/img/pic/ppp4.jpg"
                                                                             alt="依琦莲2014瑜伽服套装新"/></a>
                    <dl>
                        <!-- dt 8个文字+... -->
                        <dt><a href="#" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a></dt>
                ...
                <li>
                    <a href="#" title="富一代" target="_blank" class="pic"><img src="/res/img/pic/ppp5.jpg"
                                                                             alt="依琦莲2014瑜伽服套装新"/></a>
                    <dl>
                        <!-- dt 8个文字+... -->
                        <dt><a href="#" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a></dt>
        ...
        <div class="box bg_white">
            <ul class="uls x_50x50">
                <li>
                    <a href="#" title="富一代" target="_blank" class="pic"><img src="/res/img/pic/ppp6.jpg"
                                                                             alt="依琦莲2014瑜伽服套装新"/></a>
                    <dl>
                        <!-- dt 8个文字+... -->
                        <dt><a href="#" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a></dt>
                ...
                <li>
                    <a href="#" title="富一代" target="_blank" class="pic"><img src="/res/img/pic/ppp7.jpg"
                                                                             alt="依琦莲2014瑜伽服套装新"/></a>
                    <dl>
                        <!-- dt 8个文字+... -->
                        <dt><a href="#" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a></dt>
                ...
                <li>
                    <a href="#" title="富一代" target="_blank" class="pic"><img src="/res/img/pic/ppp8.jpg"
                                                                             alt="依琦莲2014瑜伽服套装新"/></a>
                    <dl>
                        <!-- dt 8个文字+... -->
                        <dt><a href="#" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a></dt>
                ...
                <li>
                    <a href="#" title="富一代" target="_blank" class="pic"><img src="/res/img/pic/ppp9.jpg"
                                                                             alt="依琦莲2014瑜伽服套装新"/></a>
                    <dl>
                        <!-- dt 8个文字+... -->
                        <dt><a href="#" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a></dt>
        ...
        <ul class="uls filter">
                ...
                <li><label>已选条件：</label>
                    ...
                    <p class="sel">
                        <c:forEach items="${map}" var="m">
                            <a href="javascript:void(0);" onclick="cleanFilter('${m.key}')">
                                <em>${m.key}：</em>${m.value}
                ...
                <li><b>品牌：</b>
                    ...
                    <p>
                        ...
                        <c:forEach items="${brands }" var="brand">
                            <a href="javascript:void(0);" onclick="filterBrand('${brand.id}')"
            ...
            <c:if test="${empty param.price}">
                <li><b>价格：</b>
                    ...
                    <p>
                        <a href="javascript:void(0);" title="不限" class="here">不限</a>
                        <a href="javascript:void(0);" title="1-99" onclick="filterPrice(this)">0-79</a>
                        <a href="javascript:void(0);" title="100-199" onclick="filterPrice(this)">80-199</a>
                        <a href="javascript:void(0);" title="200-299" onclick="filterPrice(this)">200-299</a>
                        <a href="javascript:void(0);" title="300-499" onclick="filterPrice(this)">300-499</a>
                        <a href="javascript:void(0);" title="500-499" onclick="filterPrice(this)">500-599</a>
                        <a href="javascript:void(0);" title="600-*" onclick="filterPrice(this)">600以上</a>
                    </p></li>
            </c:if>
            <li><b>类型：</b>
        ...
        <div class="mt ofc">
            <ul class="uls i_150x150 x4_150x150b">
                <c:forEach items="${pagination.list}" var="product">
                    <li>
                        <a href="javascript:void(0);" title="瑜伽服" class="pic" onclick="window.open('/product/detail.shtml?id=${product.id}')"><img
                                src="${product.img.allUrl}"
                                alt="瑜伽服"/></a>
                        <dl>
                            <!-- dt 10个文字+... -->
                            <dt><a href="javascript:void(0);" onclick="window.open('http://localhost:8084/html/product/${product.id}.html')">${product.name}</a>
                            </dt>
                            <!-- dt 25个文字+... -->
